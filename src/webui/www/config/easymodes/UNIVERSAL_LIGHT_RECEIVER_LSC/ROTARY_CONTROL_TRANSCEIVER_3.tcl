...
source [file join $env(DOCUMENT_ROOT) config/easymodes/UNIVERSAL_LIGHT_RECEIVER_LSC/profiles.tcl]
...
# Tunable White
set PROFILES_MAP(10)  "\${colortemp_up}"
set PROFILES_MAP(11)  "\${colortemp_down}"
set PROFILES_MAP(12)  "\${colortemp_up_down}"
set PROFILES_MAP(13)  "\${hcl_on_up}"
set PROFILES_MAP(14)  "\${hcl_off_down}"
set PROFILES_MAP(15)  "\${hcl_on_of_up_down}"
set PROFILES_MAP(16)  "\${dim2warm_on_up}"
set PROFILES_MAP(17)  "\${dim2warm_off_down}"
set PROFILES_MAP(18)  "\${dim2warm_on_of_up_down}"


# Effect
set PROFILES_MAP(19)  "\${Effect}"

set PROFILES_MAP(20)  "\${not_active}"
...
#1
  ...
  if {$longKeypressAvailable} {
    append HTML_PARAMS(separate_$prn) "<td colspan =\"2\"><hr>\${description_slowRotation}</td>"
