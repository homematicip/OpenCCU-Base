...
#-----------------------------------------------------------------------
set TYPE "HMW-Sen-SC-12-FM"

#Beschreibung des Gerätetyps
#-----------------------------------------------------------------------
#set DESCRIPTION "Schließerkontakt-Sensor Unterputzmontage (drahtgebunden)"
set DESCRIPTION "HMW-Sen-SC-12-FM"

#Pfade zu den Bildern verschiedener Größe
#lappend PATHLIST <Pixellänge maximale Ausdehnung> <Pfad zum Bild>
#-----------------------------------------------------------------------
set     PATHLIST ""
lappend PATHLIST [list  50	"/config/img/devices/50/58_hmw-sen-sc-12-fm_thumb.png"]
lappend PATHLIST [list  250	"/config/img/devices/250/58_hmw-sen-sc-12-fm.png"]
