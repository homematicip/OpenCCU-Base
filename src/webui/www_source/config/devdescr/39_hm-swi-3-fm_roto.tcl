...
#-----------------------------------------------------------------------
#set TYPE "HM-SwI-3-FM"
set TYPE "ZEL STG RM FSS UP3"

#Beschreibung des Gerätetyps
#-----------------------------------------------------------------------
# set DESCRIPTION "Funk-Schalterschnittstelle 3fach Unterputz"
set DESCRIPTION "ZEL_STG_RM_FSS_UP3"

#Pfade zu den Bildern verschiedener Größe
#lappend PATHLIST <Pixellänge maximale Ausdehnung> <Pfad zum Bild>
#-----------------------------------------------------------------------
set     PATHLIST ""
lappend PATHLIST [list  50	"/config/img/devices/50/39_hm-swi-3-fm_thumb.png"]
lappend PATHLIST [list  250	"/config/img/devices/250/39_hm-swi-3-fm.png"]
